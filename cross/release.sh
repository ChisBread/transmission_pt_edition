...
cd $TR_ROOT
sudo docker buildx build --push --platform=linux/amd64,linux/arm/v7,linux/arm64/v8 --tag chisbread/transmission:version-3.00-r13 --tag chisbread/transmission:latest -f cross/Dockerfile.buildx --no-cache .
